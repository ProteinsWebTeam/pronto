            ...
            getJSON(this.url, data => {
                ...
                data.results.forEach(protein => {
                    if (protein.isReviewed)
                        html += '<tr><td class="nowrap"><a href="/protein/'+ protein.id +'"><i class="star icon"></i>'+ protein.id +'</a></td>';
                    else
                        html += '<tr><td><a href="/protein/'+ protein.id +'">'+ protein.id +'</a></td>';
    ...
    this.renderMatches = function (data) {
        ...
        data.proteins.forEach((protein, i) => {
            ...
            protein.methods.forEach((method, j) => {
                ...
                if (method.entryId)
                    html += '<td class="nowrap"><a href="'+ method.entryId +'">'+ method.entryId +'&nbsp;<i class="external icon"></i></a></td>';
                else
                    html += '<td></td>';
