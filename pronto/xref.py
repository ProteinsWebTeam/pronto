...
"""
# Prodom has been removed in May 2019
...
"""
# Defuncts databases (or not displayed in Pronto any more)
...
class _ModBase(_Database):
    ...
    def gen_link(self):
        return 'http://modbase.compbio.ucsf.edu/modbase-cgi-new/model_search.cgi?searchvalue={}&searchproperties=database_id&displaymode=moddetail&searchmode=default'.format(
            self.ac[3:])
...
class _PDB(_Database):
    ...
    def gen_link(self):
        return 'http://www.ebi.ac.uk/pdbe-srv/view/entry/{}/summary'.format(
            self.ac)
...
class _SwissModel(_Database):
    ...
    def gen_link(self):
        return self.home + '/repository/?pid=smr03&query_1_input=' + self.ac[
                                                                     3::]
