...
(
    NAME VARCHAR2(15) NOT NULL
        CONSTRAINT PK_PRONTO_STATES
            PRIMARY KEY,
    ACTIVE CHAR NOT NULL
		CONSTRAINT CK_PRONTO_STATES$ACTIVE
			CHECK (ACTIVE='Y' OR ACTIVE='N'),
    ACTIVE_FROM DATE DEFAULT NULL
);

INSERT INTO PRONTO_STATES (NAME, ACTIVE) VALUES ('UPDATING', 'N');
INSERT INTO PRONTO_STATES (NAME, ACTIVE) VALUES ('FROZEN', 'N');
COMMIT;

GRANT SELECT ON PRONTO_STATES TO INTERPRO_SELECT;
GRANT UPDATE ON PRONTO_STATES TO INTERPRO_WEBSERVER;
```